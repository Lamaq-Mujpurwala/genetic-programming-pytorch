...
"""
Our training split is -> 80% and testing split is -> 20% which is defined in the get_scaled_data function declartion , the whole imports are a little confusing which i need to fix during refactoring the code base
"""
...
ELITISM_RATE = 0.1
MUTATION_RATE = 0.5
CROSSOVER_RATE = 0.4 # -> in without crossover the rate doesnt matter tbh
...
# toolbox.register("crossover", mean_crossover) -> We dont need that anymore
    ...
    for generation in range(GENERATIONS):
        ...
        while len(new_population) < POPULATION_SIZE:
            ...
            if operator_prob < ELITISM_RATE:
                ...
                #print(f"float fitness value outside tuple - {elite_copy.fitness.values[0]}")
            ...
            Toggling this off
                ...
                offspring = toolbox.crossover(parent1, parent2)
